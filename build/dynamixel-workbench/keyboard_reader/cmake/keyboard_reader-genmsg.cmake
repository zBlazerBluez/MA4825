...
set(MSG_I_FLAGS "-Ikeyboard_reader:/home/ryanlim95/catkin_ws/src/dynamixel-workbench/keyboard_reader/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ryanlim95/catkin_ws/src/dynamixel-workbench/keyboard_reader/msg/Key.msg" NAME_WE)
add_custom_target(_keyboard_reader_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "keyboard_reader" "/home/ryanlim95/catkin_ws/src/dynamixel-workbench/keyboard_reader/msg/Key.msg" ""
)
...
_generate_msg_cpp(keyboard_reader
  "/home/ryanlim95/catkin_ws/src/dynamixel-workbench/keyboard_reader/msg/Key.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/keyboard_reader)
  install(CODE "execute_process(COMMAND \"/home/ryanlim95/.linuxbrew/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/keyboard_reader\")")
  # install generated code
  install(
