...
"""autogenerated by genpy from dynamixel_workbench_msgs/MoveCommand.msg. Do not edit."""
import sys
...
class MoveCommand(genpy.Message):
  ...
  _type = "dynamixel_workbench_msgs/MoveCommand"
...
"""
  __slots__ = ['unit','id','goal_position','speed','to_send_command']
  _slot_types = ['string','uint8','float32','float32','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       unit,id,goal_position,speed,to_send_command
