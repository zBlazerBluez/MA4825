...
struct JointCommandResponse_
{
  ...
  (void)_alloc;
   ...
   typedef uint8_t _position_result_type;
  _position_result_type position_result;

   typedef uint8_t _speed_result_type;
...
struct MD5Sum< ::dynamixel_workbench_msgs::JointCommandResponse_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x181b1b3801e118a4ULL;
  static const uint64_t static_value2 = 0xaa1620aede17def1ULL;
};
...
struct Printer< ::dynamixel_workbench_msgs::JointCommandResponse_<ContainerAllocator> >
{
  ...
  {
    s << indent << "position_result: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.position_result);
    s << indent << "speed_result: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.speed_result);
  }
};
